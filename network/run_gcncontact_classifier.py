...
def run_contactopt(args):
    ...
    with torch.no_grad():
        ...
        for sample in tqdm(test_50_dataloader) : # test_50_dataloader # test_dataloader
            ...
            #if not (TAX_DICT_R[sample['taxonomy'][batch_index].item() + 1 ] == 1  and  sample['obj_id'].item() == 23) :
            #       continue
            if BP :
                break
            ...
            ho_mesh = hand_mesh_aug + obj_mesh_aug

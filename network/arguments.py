...
def parse_dataset(args):
    ...
    if args.split == 'aug':
        ...
        args.test_dataset = '/scratch/minjay/ContactOpt/data/HOI_BOTH_TEST.pkl'
...
def run_contactopt_parse_args():
    ...
    parser.add_argument('--jo_noise_rate', type=float, default=0.0)
    parser.add_argument('--thr_loss', type=float, default=1.00)
